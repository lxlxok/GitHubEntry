 ...
 */
public class FollowingAdapter extends BaseAdapter implements AbsListView.OnScrollListener {
    ...
    public FollowingAdapter(Context context, List<ItemFollowing> mDataList, ListView listView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // get the Bean Object
        ItemFollowing itemBean = mDataList.get(position);
